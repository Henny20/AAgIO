...
namespace AAgIO.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //private IPEndPoint epAgOpen = new IPEndPoint(IPAddress.Parse("192.168.2.255"), 15555);
        ...
        public async void LoadUDPNetwork()
        {
            helloFromAgIO[5] = 56;
            lblIP.Content = "";
            ...
            try //udp network
            {
                ...
                btnUDP.Background =  Brushes.LimeGreen;
