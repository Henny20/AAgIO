    ...
    public static class NudChk
    {
        public static bool CheckValue(this NumericUpDown numericUpDown, ref decimal value)
        {
            if (value < numericUpDown.Minimum)
            {
                ...
                callMessageBox("Serious Settings Problem with - " + numericUpDown.Name
        ...
        private async static void callMessageBox(string message)
        {
              var box = MessageBoxManager.GetMessageBoxStandard(
		       ...
		       var result = await box.ShowWindowDialogAsync(MainWindow.getInstance());    //this?   
        }   
        ...
        public static bool CheckValueCm(this NumericUpDown numericUpDown, ref double value)
        {
            ...
            if (value < (double)numericUpDown.Minimum)
            {
                ...
                MessageBoxIcon.Error);
                ****/
                Console.WriteLine("Serious Settings Problem");
                isChanged = true;
            }
